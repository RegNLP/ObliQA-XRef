# src/obliqaxref/generate/dpel/generate.py
"""
...
from obliqaxref.generate.common.llm import LLMCallResult, call_json
from obliqaxref.generate.common.prompts import (
    BASIC_QUESTION_STYLE,
    PROFESSIONAL_QUESTION_STYLE,
    SYSTEM_PROMPT_QA_GEN,
)
from obliqaxref.generate.common.validate import (
    contains_citation_like_token,
    has_required_tags,
)
from obliqaxref.generate.types import Method, Pair, Persona, QAItem
