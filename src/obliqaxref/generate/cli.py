...
from obliqaxref.config import RunConfig, load_config
from obliqaxref.utils.logging import setup_logging

app = typer.Typer(add_completion=False, help="ObliQA-XRef: cross-reference-aware benchmark toolkit.")
logger = logging.getLogger(__name__)

from dotenv import load_dotenv

from obliqaxref.adapter.cli import app as adapter_app
...
def stats(
    ...
    from obliqaxref.generate.stats.generator_stats import (
...
def curate(
    ...
    from obliqaxref.curate.run import run
...
def eval(
    ...
    from obliqaxref.eval.run import run
...
def report(
    ...
    from obliqaxref.reporting.run import run
...
def demo(
    ...
    from obliqaxref.adapter.run import run as run_adapter
    from obliqaxref.curate.run import run as run_curate
    from obliqaxref.generate.run import GenerateOverrides
    from obliqaxref.generate.run import run as run_generate
    from obliqaxref.reporting.run import run as run_report
