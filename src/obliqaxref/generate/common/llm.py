# src/obliqaxref/generate/common/llm.py
"""
ObliQA-XRef Generator — LLM utilities
...
def build_client(provider: str | None = None) -> tuple[Any, str]:
    ...
    - If provider=azure (or OBLIQAXREF_LLM_PROVIDER=azure):
    ...
    provider = (provider or _env("OBLIQAXREF_LLM_PROVIDER", "openai") or "openai").lower()
