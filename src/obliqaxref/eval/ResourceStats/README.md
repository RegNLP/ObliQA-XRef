#!/usr/bin/env python
"""
Usage: python src/obliqaxref/eval/ResourceStats/cli.py compute --corpus [ukfin|adgm]
...
python src/obliqaxref/eval/ResourceStats/cli.py compute --corpus ukfin --output-dir /custom/path
"""
