...
from obliqaxref.eval.ResourceStats.compute import main
...
def cli() -> None:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python -m obliqaxref.eval.ResourceStats.cli compute --corpus ukfin
  python -m obliqaxref.eval.ResourceStats.cli compute --corpus adgm --output-dir runs/stats/eval/resourcestats/adgm
        """,
    )
