# Evaluation Module (`obliqaxref.eval`)

Comprehensive evaluation framework for intrinsic (ResourceStats) and human evaluation (HumanEval) of the ObliQA-XRef benchmark.
...
**Usage:**
```bash
python src/obliqaxref/eval/ResourceStats/cli.py compute --corpus [ukfin|adgm]
```
...
**Usage:**
```bash
python src/obliqaxref/eval/split_cli.py --corpus [ukfin|adgm] \
...
```bash
# Single subset
python src/obliqaxref/eval/humaneval_cli.py --corpus [ukfin|adgm] \
  --subset-type [test|dev] \
  --seed 42

# Multiple subsets at once
python src/obliqaxref/eval/humaneval_cli.py --corpus adgm \
  --subset-type test dev

# With sampling
python src/obliqaxref/eval/humaneval_cli.py --corpus ukfin \
...
python src/obliqaxref/eval/split_cli.py --corpus ukfin
python src/obliqaxref/eval/split_cli.py --corpus adgm

# 2. Generate human evaluation CSVs
python src/obliqaxref/eval/humaneval_cli.py --corpus ukfin --subset-type test dev
python src/obliqaxref/eval/humaneval_cli.py --corpus adgm --subset-type test dev
