...
from obliqaxref.retrieval.bm25 import BM25Retriever
from obliqaxref.retrieval.dense import DenseRetriever
from obliqaxref.retrieval.fusion import RRFFusion
from obliqaxref.retrieval.rerank import CrossEncoderReranker
...
def main():
    ...
    if "ce_rerank_union200" in args.methods:
        ...
        if len(all_runs) >= 2:
            ...
            from obliqaxref.retrieval.types import RetrievalRun
